...
const insertDataLabVenCuotasDetalle = async (data) => {
    try {
        ...
        const query = `insert into "LAB_IFA_DATA"."IFA_VEN_CUOTA_DETALLE" values(${lineNum},TO_DATE('${docDate}', 'YYYY-MM-DD'), '','','','${tipoCliente}','${linea}','',${lineNum},'${itemCode}','',${cuotaCantidad},${cuotaVentaBs},${codAgencia},${codArea},${codZona},${0},${0},${0}, '0')`;
        console.log({ query })
